...
var blockchain = function blockchain(){
  ...
  /* 
  Here to check the validity of the chain we checked the hash of the previous block 
  and the proof of work of the current block to see if they are valid. 
  */
  ...
  function checkChain(){
    ...
    for (var i = 1; i < self.chain.length; i++) {
      ...
      if (!validator.validateProof(currentBlock.proof, previousBlock.proof)) {
        isValid = false;
        break;
      }
    }
